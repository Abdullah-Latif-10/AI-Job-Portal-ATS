    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="max-w-6xl mx-auto px-5 md:px-8 pt-16 md:pt-24 pb-16 md:pb-24 text-center">
        ...
        <div className="mt-9 flex items-center justify-center gap-3">
          ...
          <Link to="/candidate" className="inline-flex items-center gap-2 bg-card border border-border text-foreground px-6 py-3 rounded-xl text-sm font-medium hover:bg-muted transition no-underline active:scale-[0.97]">
            View demo
          </Link>
        </div>
      ...
      <section id="roles" className="max-w-6xl mx-auto px-5 md:px-8 py-16 md:py-24">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          {[
            { to: "/candidate", title: "For candidates", desc: "Build a profile, upload your resume, and let AI surface the roles that match you.", cta: "Open candidate view" },
            { to: "/recruiter", title: "For recruiters", desc: "Post roles, review AI-ranked applicants, shortlist, and schedule interviews.", cta: "Open recruiter view" },
            { to: "/admin", title: "For admins", desc: "Manage users and companies. Track platform health with live charts.", cta: "Open admin view" },
          ].map((r, i) => (
            <Link key={i} to={r.to} className="rounded-2xl bg-card border border-border p-6 hover:border-primary/40 hover:-translate-y-0.5 transition-all duration-300 group no-underline text-foreground">
      ...
      <section className="max-w-6xl mx-auto px-5 md:px-8 pb-24">
        <div className="rounded-3xl bg-primary text-primary-foreground p-10 md:p-16 text-center shadow-lg">
          ...
          <div className="mt-8 flex items-center justify-center gap-3 flex-wrap">
            <Link to="/candidate" className="bg-background text-foreground px-5 py-2.5 rounded-xl text-sm font-medium hover:bg-background/90 transition no-underline shadow-sm active:scale-[0.97]">Candidate demo</Link>
            <Link to="/recruiter" className="bg-transparent border border-primary-foreground/20 text-primary-foreground px-5 py-2.5 rounded-xl text-sm font-medium hover:bg-white/10 transition no-underline active:scale-[0.97]">Recruiter demo</Link>
            <Link to="/admin" className="bg-transparent border border-primary-foreground/20 text-primary-foreground px-5 py-2.5 rounded-xl text-sm font-medium hover:bg-white/10 transition no-underline active:scale-[0.97]">Admin demo</Link>
          </div>
        </div>
      </section>
